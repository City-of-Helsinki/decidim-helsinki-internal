...
# Fixes the following bugs in core (can be removed after 0.25 update):
# https://github.com/decidim/decidim/pull/7381 (fixed in 0.24)
# https://github.com/decidim/decidim/pull/7890 (fixed in 0.25, if PR is merged)
module Decidim
