/**
 * This is modified to add the screen reader character counter extensions.
 */
((exports) => {
  ...
  class InputCharacterCounter {
     ...
     * whether the user is currently adding or deleting characters from the
     * view.
     *
     * @returns {String} The input direction either "ins" for insert or "del"
     *   for delete.
     */
    getInputDirection() {
