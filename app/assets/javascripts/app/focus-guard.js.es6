((exports) => {
  ...
  const Keyboard = exports.Foundation.Keyboard;
  ...
  class FocusGuard {
    ...
    trap(element) {
      ...
      // keyboard trap twice. Note that the Foundation methods expect the
      // elements to be jQuery elements which is why we pass them through
      // jQuery.
