...
Rails.application.configure do
  ...
  config.action_controller.asset_host = "https://kiihdyttamo.hel.ninja"
  ...
  config.active_job.queue_name_prefix = "decidim-hkikiihdyttamostag_#{Rails.env}"
