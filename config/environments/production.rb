...
Rails.application.configure do
  ...
  config.action_controller.asset_host = "https://kokeilukiihdyttamo.hel.fi"
  ...
  config.active_job.queue_name_prefix = "decidim-hkikiihdyttamoprod_#{Rails.env}"
  ...
  config.action_controller.default_url_options = {
    ...
    host: "kokeilukiihdyttamo.hel.fi",
    port: 443
  }
